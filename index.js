...
console.log('task 1b', createMenuItem('breakfast sandwich', 6, 'Brunch'));
console.log('task 1b', createMenuItem('ice cream', 3, 'Dessert'));
...
addReview.push('Daniela', 5, 'Beautiful atmosphere and wonderful vegan options!')
